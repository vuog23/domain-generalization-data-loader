...
from src.data.single_domain.vlcs_dataset import SplitDomainDataset
...
def build_split_domain_class_to_idx(root_path, splits=("train", "test")):
...
def make_split_loaders(
    ...
    class_to_idx = build_split_domain_class_to_idx(
        root_path=root_path,
        splits=("train", "test"),
    )
